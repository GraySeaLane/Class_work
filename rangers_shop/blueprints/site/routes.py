...
#need to instantiate our blue print class
...
def shop():
    ...
    allprods = Product.query.all() #the same as SELECT * FROM products , list of products
    ...
    return render_template('shop.html', shop=allprods, stats=shop_stats ) #looking inside our template folder to find the shop.html file
...
def update(id):
    ...
    #let us grab our specific product we want to update
    product = Product.query.get(id) #this should only bring back one item/object
